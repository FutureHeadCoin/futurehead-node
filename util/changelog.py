...
class cliArgs():
    def __init__(self):
        ...
        parse.add_argument(
            ...
            default='futureheadcurrency/futurehead-node',
        )
        parse.add_argument(
            '-s', '--start',
...
class generateMarkdown():
    ...
    def __init__(self, repo):
        ...
        self.mdFile.new_line(
            "## **Release** " + \
            "[{0}](https://github.com/futureheadcurrency/futurehead-node/tree/{0})"\
                .format(repo.end))
        self.mdFile.new_line("[Full Changelog](https://github.com/futureheadcurrency"\
            "/futurehead-node/compare/{0}...{1})".format(repo.start, repo.end))
