...
futurehead::tomlconfig::tomlconfig () :
tree (cpptoml::make_table ())
{
	error = std::make_shared<futurehead::error> ();
}

futurehead::tomlconfig::tomlconfig (std::shared_ptr<cpptoml::table> const & tree_a, std::shared_ptr<futurehead::error> const & error_a) :
...
void futurehead::tomlconfig::doc (std::string const & key, std::string const & doc)
{
	tree->document (key, doc);
}

futurehead::error & futurehead::tomlconfig::read (boost::filesystem::path const & path_a)
{
...
futurehead::error & futurehead::tomlconfig::read (std::istream & stream_overrides, boost::filesystem::path const & path_a)
{
	std::fstream stream;
...
futurehead::error & futurehead::tomlconfig::read (std::istream & stream_a)
{
	std::stringstream stream_override_empty;
	stream_override_empty << std::endl;
...
futurehead::error & futurehead::tomlconfig::read (std::istream & stream_first_a, std::istream & stream_second_a)
{
	try
	{
...
void futurehead::tomlconfig::write (boost::filesystem::path const & path_a)
{
	std::fstream stream;
	open_or_create (stream, path_a.string ());
	write (stream);
...
void futurehead::tomlconfig::write (std::ostream & stream_a) const
{
...
void futurehead::tomlconfig::open_or_create (std::fstream & stream_a, std::string const & path_a)
{
...
std::shared_ptr<cpptoml::table> futurehead::tomlconfig::get_tree ()
{
	return tree;
}

/** Returns true if the toml table is empty */
bool futurehead::tomlconfig::empty () const
{
	return tree->empty ();
}

boost::optional<futurehead::tomlconfig> futurehead::tomlconfig::get_optional_child (std::string const & key_a)
{
...
futurehead::tomlconfig futurehead::tomlconfig::get_required_child (std::string const & key_a)
{
	if (!tree->contains (key_a))
	{
...
futurehead::tomlconfig & futurehead::tomlconfig::put_child (std::string const & key_a, futurehead::tomlconfig & conf_a)
{
	tree->insert (key_a, conf_a.get_tree ());
	return *this;
}

futurehead::tomlconfig & futurehead::tomlconfig::replace_child (std::string const & key_a, futurehead::tomlconfig & conf_a)
{
	tree->erase (key_a);
...
bool futurehead::tomlconfig::has_key (std::string const & key_a)
{
	return tree->contains (key_a);
}

/** Erase the property of given key */
futurehead::tomlconfig & futurehead::tomlconfig::erase (std::string const & key_a)
{
	tree->erase (key_a);
	return *this;
}

std::shared_ptr<cpptoml::array> futurehead::tomlconfig::create_array (std::string const & key, boost::optional<const char *> documentation_a)
{
	if (!has_key (key))
	{
...
/**
	 ...
	 */
void futurehead::tomlconfig::erase_default_values (tomlconfig & defaults_a)
{
...
std::string futurehead::tomlconfig::to_string ()
{
	std::stringstream ss;
...
std::string futurehead::tomlconfig::to_string_commented_entries ()
{
...
futurehead::tomlconfig & futurehead::tomlconfig::get_config (bool optional, std::string const & key, uint8_t & target, uint8_t default_value)
{
	try
	{
...
futurehead::tomlconfig & futurehead::tomlconfig::get_config (bool optional, std::string const & key, bool & target, bool default_value)
{
...
void futurehead::tomlconfig::erase_defaults (std::shared_ptr<cpptoml::table> base, std::shared_ptr<cpptoml::table> other, std::shared_ptr<cpptoml::table> update_target)
{
...
futurehead::tomlconfig & futurehead::tomlconfig::get_config (bool optional, std::string key, boost::asio::ip::address_v6 & target, boost::asio::ip::address_v6 const & default_value)
{
	try
	{
		if (tree->contains_qualified (key))
