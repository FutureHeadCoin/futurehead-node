...
futurehead::error futurehead::diagnostics_config::serialize_json (futurehead::jsonconfig & json) const
{
...
futurehead::error futurehead::diagnostics_config::deserialize_json (futurehead::jsonconfig & json)
{
...
futurehead::error futurehead::diagnostics_config::serialize_toml (futurehead::tomlconfig & toml) const
{
	futurehead::tomlconfig txn_tracking_l;
...
futurehead::error futurehead::diagnostics_config::deserialize_toml (futurehead::tomlconfig & toml)
{
