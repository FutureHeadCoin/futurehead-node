...
#include <futurehead/boost/asio/executor_work_guard.hpp>
...
namespace thread_role
{
	 ...
	 */
	futurehead::thread_role::name get ();
	void set (futurehead::thread_role::name);

	/*
	 * Get the thread name as a string from enum
	 */
	std::string get_string (futurehead::thread_role::name);
