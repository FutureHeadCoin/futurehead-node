...
public:
	timer () = default;
	timer (futurehead::timer_state state_a, std::string const & description_a = "timer");
	...
	futurehead::timer_state current_state () const;

private:
	timer * parent{ nullptr };
	std::vector<timer> children;
	futurehead::timer_state state{ futurehead::timer_state::stopped };
	std::string desc;
