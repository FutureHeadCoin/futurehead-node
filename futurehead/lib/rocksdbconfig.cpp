...
futurehead::error futurehead::rocksdb_config::serialize_toml (futurehead::tomlconfig & toml) const
{
...
futurehead::error futurehead::rocksdb_config::deserialize_toml (futurehead::tomlconfig & toml)
{
