...
class configbase : public futurehead::error_aware<>
{
public:
	configbase () = default;
	configbase (std::shared_ptr<futurehead::error> const & error_a) :
	error (error_a)
	{
	}

	/** Returns the current error */
	futurehead::error & get_error () override
	{
		return *error;
	}
...
protected:
	...
	/** We're a futurehead::error_aware type. Child nodes share the error state. */
	std::shared_ptr<futurehead::error> error;
