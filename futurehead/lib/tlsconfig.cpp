...
{
    futurehead::error futurehead::tls_config::serialize_toml(futurehead::tomlconfig &toml) const
    {
    ...
    futurehead::error futurehead::tls_config::deserialize_toml(futurehead::tomlconfig &toml)
    {
    ...
    namespace
    {
        bool on_verify_certificate(bool preverified, boost::asio::ssl::verify_context &ctx, futurehead::tls_config &config_a, futurehead::logger_mt &logger_a)
        {
        ...
        void load_certs(futurehead::tls_config &config_a, futurehead::logger_mt &logger_a)
        {
            try
            {
    ...
    futurehead::error read_tls_config_toml(boost::filesystem::path const &data_path_a, futurehead::tls_config &config_a, futurehead::logger_mt &logger_a, std::vector<std::string> const &config_overrides)
    {
        futurehead::error error;
        auto toml_config_path = futurehead::get_tls_toml_config_path(data_path_a);
...
#else
            auto msg("https or wss is enabled in the TLS configuration, but the node is not built with FUTUREHEAD_SECURE_RPC");
