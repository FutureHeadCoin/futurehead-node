...
namespace ipc
{
	/** Produces Futurehead API compliant Flatbuffers from objects and builders */
	...
	public:
		...
		{
			futurehead::ipc::flatbuffer_producer producer;
		...
		auto make_envelope (flatbuffers::Offset<T> obj)
		{
			...
			futureheadapi::EnvelopeBuilder envelope_builder (*fbb);
			...
			envelope_builder.add_message_type (futureheadapi::MessageTraits<T>::enum_value);
