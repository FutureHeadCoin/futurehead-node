...
namespace ipc
{
	 ...
	 * @throws Methods of this class throw futurehead::error on failure.
	...
	public:
		 ...
		 */
		flatbuffers_handler (futurehead::node & node_a, futurehead::ipc::ipc_server & ipc_server_a, std::shared_ptr<futurehead::ipc::subscriber> const & subscriber_a, futurehead::ipc::ipc_config const & ipc_config_a);
		 ...
		 */
		static std::shared_ptr<flatbuffers::Parser> make_flatbuffers_parser (futurehead::ipc::ipc_config const & ipc_config_a);
	...
	private:
		...
		futurehead::ipc::ipc_config const & ipc_config;
	};
}
}
