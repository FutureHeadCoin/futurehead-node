...
futurehead::error futurehead::ipc::ipc_config::serialize_toml (futurehead::tomlconfig & toml) const
{
	futurehead::tomlconfig tcp_l;
	...
	futurehead::tomlconfig domain_l;
	...
	futurehead::tomlconfig flatbuffers_l;
...
futurehead::error futurehead::ipc::ipc_config::deserialize_toml (futurehead::tomlconfig & toml)
{
...
futurehead::error futurehead::ipc::ipc_config::serialize_json (futurehead::jsonconfig & json) const
{
	futurehead::jsonconfig tcp_l;
	// Only write out experimental config values if they're previously set explicitly in the config file
	if (transport_tcp.io_threads >= 0)
	{
	...
	futurehead::jsonconfig domain_l;
...
futurehead::error futurehead::ipc::ipc_config::deserialize_json (bool & upgraded_a, futurehead::jsonconfig & json)
{
