...
#include <futurehead/boost/beast/core.hpp>
#include <futurehead/boost/beast/websocket.hpp>
...
namespace futurehead::websocket
{
/** The minimal stream interface needed by the Futurehead websocket implementation */
...
public:
	...
	virtual void async_write (futurehead::shared_const_buffer const & buffer_a, std::function<void(boost::system::error_code, std::size_t)> callback_a) = 0;
