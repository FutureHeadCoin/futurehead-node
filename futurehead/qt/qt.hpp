...
public:
	...
	QPushButton * back;
	futurehead_qt::wallet & wallet;
};
class advanced_actions
{
public:
	advanced_actions (futurehead_qt::wallet &);
	QWidget * window;
	QVBoxLayout * layout;
	...
	QRadioButton * mfuturehead_unit;
	QRadioButton * kfuturehead_unit;
	QRadioButton * futurehead_unit;
...
{
public:
	block_entry (futurehead_qt::wallet &);
	QWidget * window;
	QVBoxLayout * layout;
...
{
public:
	block_creation (futurehead_qt::wallet &);
	void deactivate_all ();
	void activate_send ();
...
{
public:
	self_pane (futurehead_qt::wallet &, futurehead::account const &);
	void set_balance_text (std::pair<futurehead::uint128_t, futurehead::uint128_t>);
	QWidget * window;
	QVBoxLayout * layout;
...
{
public:
	history (futurehead::ledger &, futurehead::account const &, futurehead_qt::wallet &);
	void refresh ();
	QWidget * window;
	QVBoxLayout * layout;
	QStandardItemModel * model;
...
{
public:
	block_viewer (futurehead_qt::wallet &);
	void rebroadcast_action (futurehead::block_hash const &);
	QWidget * window;
	QVBoxLayout * layout;
	QLabel * hash_label;
	QLineEdit * hash;
...
{
public:
	account_viewer (futurehead_qt::wallet &);
	QWidget * window;
	QVBoxLayout * layout;
	QLabel * account_label;
...
{
public:
	stats_viewer (futurehead_qt::wallet &);
	QWidget * window;
	QVBoxLayout * layout;
	QPushButton * refresh;
	QPushButton * clear;
...
{
public:
	status (futurehead_qt::wallet &);
	void erase (futurehead_qt::status_types);
	void insert (futurehead_qt::status_types);
	void set_text ();
	std::string text ();
	std::string color ();
	std::set<futurehead_qt::status_types> active;
	futurehead_qt::wallet & wallet;
};
class wallet : public std::enable_shared_from_this<futurehead_qt::wallet>
{
public:
	wallet (QApplication &, futurehead_qt::eventloop_processor &, futurehead::node &, std::shared_ptr<futurehead::wallet>, futurehead::account &);
	void start ();
	void refresh ();
	void update_connected ();
	void empty_password ();
	void change_rendering_ratio (futurehead::uint128_t const &);
	std::string format_balance (futurehead::uint128_t const &) const;
	futurehead::uint128_t rendering_ratio;
	futurehead::node & node;
	std::shared_ptr<futurehead::wallet> wallet_m;
	futurehead::account & account;
	futurehead_qt::eventloop_processor & processor;
	futurehead_qt::history history;
	futurehead_qt::accounts accounts;
	futurehead_qt::self_pane self;
	futurehead_qt::settings settings;
	futurehead_qt::advanced_actions advanced;
	futurehead_qt::block_creation block_creation;
	futurehead_qt::block_entry block_entry;
	futurehead_qt::block_viewer block_viewer;
	futurehead_qt::account_viewer account_viewer;
	futurehead_qt::stats_viewer stats_viewer;
	futurehead_qt::import import;
	...
	futurehead_qt::status active_status;
	void pop_main_stack ();
